...
var Refresh = require("5f517404f1e8ada9");
var ErrorOverlay = require("9dd70e9d89112693");
...
},{"5f517404f1e8ada9":"786KC","9dd70e9d89112693":"1dldy"}],"786KC":[function(require,module,exports) {
"use strict";
module.exports = require("af3c492c2e577024");

},{"af3c492c2e577024":"hdge7"}],"hdge7":[function(require,module,exports) {
...
var process = require("225dda9f31cc6ab3");
!function(e, t) {
    module.exports = t();
}(window, function() {
    return function(e) {
...
},{"225dda9f31cc6ab3":"d5jf4"}],"d5jf4":[function(require,module,exports) {
...
},{}],"6Xfl7":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "59705d595f1ec19f";
"use strict";
...
},{}],"hbtnW":[function(require,module,exports) {
var _appJs = require("./App.js");
document.addEventListener("DOMContentLoaded", (0, _appJs.App)());

},{"./App.js":"aQoef"}],"aQoef":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "App", ()=>App);
var _eventosBtnJs = require("./components/Popul/EventosBtn.js");
var _headerJs = require("./components/Header.js");
var _mainJs = require("./components/Main.js");
var _apiPeliJs = require("./helpers/Api_Peli.js");
var _apiPeliJsDefault = parcelHelpers.interopDefault(_apiPeliJs);
var _buttonCarritoJs = require("./components/Carrito/ButtonCarrito.js");
var _sideBarJs = require("./components/Carrito/SideBar.js");
var _comprarJs = require("./components/Carrito/Comprar.js");
var _buscarLocalStoreJs = require("./components/Carrito/BuscarLocalStore.js");
function App() {
    const $root = document.getElementById("root");
    $root.appendChild((0, _headerJs.Header)());
    $root.appendChild((0, _mainJs.Main)());
    (0, _buscarLocalStoreJs.buscarLocalStore)();
    (0, _eventosBtnJs.eventosBtn)((0, _apiPeliJsDefault.default).APIPelPopularesCine);
    setTimeout(()=>{
        (0, _buttonCarritoJs.buttonCarrito)();
        (0, _sideBarJs.sidebar)();
        (0, _comprarJs.Comprar)();
    }, 1000);
}
_c = App;
var _c;
...
},{"./components/Popul/EventosBtn.js":"aF30f","./components/Header.js":"7eF8P","./components/Main.js":"eyzU3","./helpers/Api_Peli.js":"j9qG8","./components/Carrito/ButtonCarrito.js":"fLRTy","./components/Carrito/SideBar.js":"h6L38","./components/Carrito/Comprar.js":"bWJYu","./components/Carrito/BuscarLocalStore.js":"6cv0j","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aF30f":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "eventosBtn", ()=>eventosBtn);
var _apiPeliJs = require("../../helpers/Api_Peli.js");
var _apiPeliJsDefault = parcelHelpers.interopDefault(_apiPeliJs);
function eventosBtn(props) {
    let API = props;
    const $bg = document.getElementById("Recientes"), $botena = document.getElementById("menu-tendencias"), $imgpo = document.getElementById("tendecias");
    const RenderTendecias = async (API)=>{
        try {
            ...
            } else console.log("error del api");
        } catch (error) {
            console.log(error);
        }
    };
    $botena.addEventListener("click", (e)=>{
        if (e.target.matches("#tendenciaCine")) RenderTendecias((0, _apiPeliJsDefault.default).APIPelPopularesCine);
        else if (e.target.matches("#enTelevision")) RenderTendecias((0, _apiPeliJsDefault.default).APIEnTelevision);
        else if (e.target.matches("#Proximante")) RenderTendecias((0, _apiPeliJsDefault.default).APIPelProximamente);
        else if (e.target.matches("#Reciente")) RenderTendecias((0, _apiPeliJsDefault.default).APIPelRecientes);
        else if (e.target.matches("#mejorValoradasCine")) RenderTendecias((0, _apiPeliJsDefault.default).APIPelMCTMDBEl);
        else if (e.target.matches("#mejorValoradasTv")) RenderTendecias((0, _apiPeliJsDefault.default).APIPelMCTMDBElTv);
    });
...
},{"../../helpers/Api_Peli.js":"j9qG8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j9qG8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const APIGenerosCine = "https://api.themoviedb.org/3/genre/movie/list?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE", APIGenerosTv = "https://api.themoviedb.org/3/genre/tv/list?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE", APIPelPopularesCine = "https://api.themoviedb.org/3/movie/popular?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE&with_genres=", APIPelTendencias = "https://api.themoviedb.org/3/trending/movie/day?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE", APIPelRecientes = "https://api.themoviedb.org/3/movie/now_playing?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE", APIPelProximamente = "https://api.themoviedb.org/3/movie/upcoming?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE", APIPelMCTMDBEl = "https://api.themoviedb.org/3/movie/top_rated?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE", APIPelMCTMDBElTv = "https://api.themoviedb.org/3/tv/top_rated?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE", APIEnTelevision = "https://api.themoviedb.org/3/tv/on_the_air?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE", APIPelPopularesTv = "https://api.themoviedb.org/3/tv/popular?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE&with_genres=", APIBuscarCine = "https://api.themoviedb.org/3/search/multi?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE&page=1&include_adult=false&query=";
let Carrito = [];
exports.default = {
    APIGenerosCine,
    APIGenerosTv,
...
},{}],"7eF8P":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Header", ()=>Header);
var _navbarJs = require("./HeaderComponents/Navbar.js");
const d = document;
function Header() {
    const $main = document.getElementById("root"), $header = d.createElement("header");
    $header.classList.add("fijo");
    $header.appendChild((0, _navbarJs.Navbar)());
...
},{"./HeaderComponents/Navbar.js":"2kNu8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2kNu8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Navbar", ()=>Navbar);
var _listasJs = require("./Listas.js");
const d = document;
function Navbar() {
    const $nav = d.createElement("nav"), $div = d.createElement("div"), $a = d.createElement("a"), $button = d.createElement("button"), $span = d.createElement("span"), $form = d.createElement("form"), $img = d.createElement("img");
    $nav.classList.add("navbar", "navbar-expand-lg", "bg-dark");
    $div.classList.add("container-fluid");
    $nav.setAttribute("data-bs-theme", "dark"), $form.classList.add("d-flex");
    $form.role = "search";
    $form.id = "formulario";
    $a.href = "#";
    ...
    $img.src = `https://arsistema.com/guias/paginasweb/api/peliculas03/public/img/logopeliclas.svg`;
    $img.classList.add();
    $a.appendChild($img);
    $form.innerHTML = `
    ...
    $div.appendChild((0, _listasJs.Listas)());
...
},{"./Listas.js":"ajQlQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ajQlQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Listas", ()=>Listas);
var _fetchgenresJs = require("../../helpers/Fetchgenres.js");
var _btnListJs = require("./BtnList.js");
var _apiPeliJs = require("../../helpers/Api_Peli.js");
var _apiPeliJsDefault = parcelHelpers.interopDefault(_apiPeliJs);
const d = document;
function Listas() {
    const $div = d.createElement("div"), $ul = d.createElement("ul"), $li1 = d.createElement("li"), $li2 = d.createElement("li"), $li3 = d.createElement("li"), $a = d.createElement("a"), $a2 = d.createElement("a"), $ulINS = d.createElement("ul"), $ulINS2 = d.createElement("ul");
    let id = "navbarDropdown", role = "button";
        ...
        $generos.addEventListener("click", (e)=>{
            if (e.target.matches(".dropdown-toggle")) {
                ...
                if (e.target.dataset.id === "Tvgenres") {
                    Api = (0, _apiPeliJsDefault.default).APIGenerosTv;
                    tipo = "Tv";
                }
                if (e.target.dataset.id === "Pelicuasgenres") {
                    Api = (0, _apiPeliJsDefault.default).APIGenerosCine;
                    tipo = "Cine";
                }
                (0, _fetchgenresJs.Ajax)(tipo, {
                    url: Api,
                    cbSuccess: (data, tipo)=>{
                        let html = "";
                        data.forEach((el)=>{
                            html += (0, _btnListJs.BtnList)(el, tipo);
                        });
...
_c = Listas;
var _c;
$RefreshReg$(_c, "Listas");

},{"../../helpers/Fetchgenres.js":"izVPP","./BtnList.js":"9pZdj","../../helpers/Api_Peli.js":"j9qG8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"izVPP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Ajax", ()=>Ajax);
async function Ajax(tipo, props) {
    let { url , cbSuccess  } = props;
    await fetch(url).then((res)=>res.ok ? res.json() : Promise.reject(res)).then((json)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9pZdj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "BtnList", ()=>BtnList);
function BtnList(props, tipo) {
    let { id , name  } = props;
    return `<li><a class="dropdown-item" href="#" id="${id}" name="${name}" data-tipo="${tipo}">${name}</a></li>`;
}
_c = BtnList;
var _c;
$RefreshReg$(_c, "BtnList");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eyzU3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Main", ()=>Main);
var _popularesJs = require("./Populares.js");
var _mostradorContentJs = require("./MostradorContent.js");
var _modalJs = require("./Mostrador/Modal.js");
const d = document;
function Main() {
    const $main = d.createElement("main");
    $main.id = "main";
    $main.classList.add("container-my");
    $main.appendChild((0, _popularesJs.Populares)());
    $main.appendChild((0, _mostradorContentJs.MostradorContent)());
    $main.appendChild((0, _modalJs.modalDetalles)());
    return $main;
}
_c = Main;
var _c;
...
},{"./Populares.js":"aVO7m","./MostradorContent.js":"lY7sO","./Mostrador/Modal.js":"436Q9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aVO7m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Populares", ()=>Populares);
var _botoneraJs = require("./Popul/Botonera.js");
var _cardPopularesJs = require("./Popul/CardPopulares.js");
function Populares() {
    const $populares = document.createElement("div");
    $populares.classList.add("container-my");
    $populares.id = "Recientes";
    $populares.appendChild((0, _botoneraJs.Botonera)());
    $populares.appendChild((0, _cardPopularesJs.cardPopulares)());
    return $populares;
}
_c = Populares;
var _c;
...
},{"./Popul/Botonera.js":"gVVMc","./Popul/CardPopulares.js":"7B8SU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gVVMc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Botonera", ()=>Botonera);
function Botonera() {
    const $botonera = document.createElement("div");
    $botonera.id = "menu-tendencias";
    $botonera.classList.add("d-flex", "justify-content-center"), $botonera.innerHTML = `
...
_c = Botonera;
var _c;
$RefreshReg$(_c, "Botonera");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7B8SU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "cardPopulares", ()=>cardPopulares);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lY7sO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MostradorContent", ()=>MostradorContent);
var _renderpeliculasJs = require("../helpers/Renderpeliculas.js");
const d = document;
function MostradorContent() {
    //Creacion de los Elementos div para hacer el inserte de los componentes Html para el mostrador
    const $Mostrador = d.createElement("div"), $Row = d.createElement("div"), $col = d.createElement("div"), $card = d.createElement("div"), $h2 = d.createElement("h2");
    ...
    $h2.classList.add("d-flex", "justify-content-center", "text-white", "fw-bolder");
    ...
    setTimeout(()=>{
        (0, _renderpeliculasJs.renderPeliculas)();
    }, 300);
...
_c = MostradorContent;
var _c;
$RefreshReg$(_c, "MostradorContent");

},{"../helpers/Renderpeliculas.js":"fxsUO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fxsUO":[function(require,module,exports) {
// Importacion de componentes 
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderPeliculas", ()=>renderPeliculas);
var _apiPeliJs = require("./Api_Peli.js");
var _apiPeliJsDefault = parcelHelpers.interopDefault(_apiPeliJs);
var _fetchpeliJs = require("./Fetchpeli.js");
var _renderCardsJs = require("../components/Mostrador/RenderCards.js");
const d = document;
function renderPeliculas() {
    //declaracion de  las constantes para el evento click
    const $genres = d.getElementById("listas"), //declaracion de  las constantes para filtar las cards
    form = d.getElementById("formulario"), $input = d.querySelector(".buscarText");
    //Peticion a la api para renderisar las cards
    (0, _fetchpeliJs.Ajaxresutls)(28, "Accion", "Cine", "", {
        API: (0, _apiPeliJsDefault.default).APIPelPopularesCine,
        renderPeliculasPopulares: (datos, name, tipo)=>{
            localStorage.setItem("Tipo", tipo);
            (0, _renderCardsJs.renderCards)(datos, name, tipo);
        }
    });
    //Peticion a la api para renderisar las cards mediante un evento click
    $genres.addEventListener("click", (e)=>{
        if (e.target.matches("#Pelicuasgenre a") || e.target.matches("#Tvgenre a")) {
            let id = e.target.id, name = e.target.name, tipo = e.target.dataset.tipo;
            let Api;
            if (tipo === "Tv") Api = (0, _apiPeliJsDefault.default).APIPelPopularesTv;
            else if (tipo === "Cine") Api = (0, _apiPeliJsDefault.default).APIPelPopularesCine;
            (0, _fetchpeliJs.Ajaxresutls)(id, name, tipo, "", {
                API: Api,
                renderPeliculasPopulares: (datos, name, tipo)=>(0, _renderCardsJs.renderCards)(datos, name, tipo)
            });
        }
    });
    ...
    setTimeout(()=>{
        ...
        form.addEventListener("submit", (e)=>{
            e.preventDefault();
            const textbuscar = $input.value, pag = 1;
            let query = localStorage.getItem("Tipo");
            let tipo = query;
            (0, _fetchpeliJs.Ajaxresutls)("", "", tipo, textbuscar, {
                API: (0, _apiPeliJsDefault.default).APIBuscarCine + textbuscar + "&page=" + pag,
                renderPeliculasPopulares: (datos, name, tipo, textbuscar)=>(0, _renderCardsJs.renderCards)(datos, name, tipo, textbuscar)
            });
            d.addEventListener("keyup", (e)=>{
                if (e.target.matches(".buscarText")) {
                    if (e.key === "Escape") {
                        ...
                        (0, _fetchpeliJs.Ajaxresutls)(28, "Accion", "Cine", "", {
                            API: (0, _apiPeliJsDefault.default).APIPelPopularesCine,
                            renderPeliculasPopulares: (datos, name)=>(0, _renderCardsJs.renderCards)(datos, name)
                        });
                    }
                }
            });
...
},{"./Api_Peli.js":"j9qG8","./Fetchpeli.js":"gxLy5","../components/Mostrador/RenderCards.js":"6Xq1L","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gxLy5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Ajaxresutls", ()=>Ajaxresutls);
async function Ajaxresutls(id, name, tipo, text, props) {
    ...
    try {
        ...
        if (resp.status === 200) {
            const datos = await resp.json();
            let content;
            if (name === "detalle") content = datos;
            else content = datos.results;
            if (name === "comprar") {
...
_c = Ajaxresutls;
var _c;
$RefreshReg$(_c, "Ajaxresutls");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6Xq1L":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderCards", ()=>renderCards);
var _cardPeliculasJs = require("../Mostrador/CardPeliculas.js");
const d = document;
function renderCards(datos, name, tipo, textbuscar) {
    setTimeout(()=>{
        const $card = d.getElementById("mostarPeliculas"), $h2 = d.getElementById("titulos"), $bg = d.getElementById("Mostrador");
        $h2.innerHTML = `Generos: ${name}`;
        if (textbuscar) $h2.innerHTML = `Has buscado : ${textbuscar}`;
        let html = "", fondo = "", titulo;
        datos.forEach((el)=>{
            fondo = `url(https://image.tmdb.org/t/p/original${el.backdrop_path})`;
            titulo = el.name;
            if (titulo === undefined) titulo = el.title;
            html += (0, _cardPeliculasJs.CardPelicula)(el, titulo, tipo);
        });
        $card.innerHTML = html;
        $bg.style.backgroundImage = fondo;
    }, 200);
...
},{"../Mostrador/CardPeliculas.js":"eTkCt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eTkCt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CardPelicula", ()=>CardPelicula);
var _getColorsJs = require("../../helpers/GetColors.js");
function CardPelicula(props, titulo, tipo) {
    let { poster_path , vote_average , id , type  } = props;
    let tipos;
    if (type === "Scripted") tipos = type;
    else tipos = tipo;
    return `<div class="col-sm-6 col-md-4 col-lg-3 mb-1" id="cardsmostrador" >
 <div class="card bg-black bg-opacity-25 box hei">    
   <div class="card-header p-0">
         <img src="https://image.tmdb.org/t/p/w500${poster_path}" alt="..." class="img-fluid rounded-1">
 </div>
 <div class="card-body">
     <h5 class="text-center text-white  text-truncate">${titulo}</h5>
   
     <p class="text-warning text-center">Average <span class="badge rounded-pill p-2 ${(0, _getColorsJs.getColor)(vote_average)} ">${vote_average}</span></p>
 </div>
 <div class="card-footer text-center d-flex justify-content-center aling-items-center" >
  ...
  <a href="#" class="btn btn-outline-danger m-1 p-1" data-bs-toggle="modal" data-bs-target="#exampleModal" id=${id} name="detalle" data-tipo="${tipo}"> Detalles</a>
 </div>
</div>
</div>`;
}
_c = CardPelicula;
var _c;
$RefreshReg$(_c, "CardPelicula");

},{"../../helpers/GetColors.js":"28nM3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"28nM3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getColor", ()=>getColor);
function getColor(voto) {
    if (voto >= 7.5) return "bg-success";
    else if (voto >= 5) return "bg-warning text-dark";
    else return "bg-danger";
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"436Q9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "modalDetalles", ()=>modalDetalles);
var _fetchpeliJs = require("../../helpers/Fetchpeli.js");
var _modalDetallesJs = require("./ModalDetalles.js");
const d = document;
function modalDetalles() {
    const $modal = d.createElement("modal"), $modalDialog = d.createElement("div"), $modalContent = d.createElement("div"), $modalHeader = d.createElement("div"), $modalTile = d.createElement("h1"), $modalBody = d.createElement("div"), $modalFooter = d.createElement("div"), $buttonClose = d.createElement("button"), $buttonComprar = d.createElement("button"), $buttonCerrar = d.createElement("button");
  ...
  `;
    ...
    d.addEventListener("click", (e)=>{
        if (e.target.name === "detalle") {
            let id = e.target.id, name = e.target.name, tipo = e.target.dataset.tipo;
            let APIDetalles;
            if (tipo === "Cine") APIDetalles = `https://api.themoviedb.org/3/movie/${id}?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-ES`;
            else if (tipo === "Tv") APIDetalles = `https://api.themoviedb.org/3/tv/${id}?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-ES`;
            setTimeout(()=>{
                (0, _fetchpeliJs.Ajaxresutls)(id, name, tipo, "", {
                    API: APIDetalles,
                    renderPeliculasPopulares: (datos)=>(0, _modalDetallesJs.RenderDetalles)(datos)
                });
            }, 200);
        }
    });
...
},{"../../helpers/Fetchpeli.js":"gxLy5","./ModalDetalles.js":"gMLnM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gMLnM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "RenderDetalles", ()=>RenderDetalles);
var _getColorsJs = require("../../helpers/GetColors.js");
const d = document;
function RenderDetalles(datos) {
    const $tituloModal = d.getElementById("exampleModalLabel"), $modalBody = d.getElementById("modal");
    let productora, titulos, title, date;
    if (datos.production_companies[0] === undefined) productora = "Sin productora";
    else productora = datos.production_companies[0].name;
    if (datos.original_title === undefined) titulos = datos.name;
    else titulos = datos.production_companies[0].name;
    if (datos.title === undefined) title = datos.name;
    else title = datos.title;
    if (datos.release_date === undefined) date = "Sin fecha de lanzamiento";
    else date = datos.release_date;
    $tituloModal.innerHTML = `${title}`;
    let html = `
                <div class="row">
                  <div class="col-5">
                    <img src="https://image.tmdb.org/t/p/w500${datos.poster_path}" alt="" class="img-fluid rounded-1" width="300px" height="550px">
                  </div>
                  <div class="col-7 text-white">
                    <h5 class="small"><b>Titulo Original:${titulos}</b></h5>
                    <h5 class="small"><b>Genero:${datos.genres[0].name}</b></h5>
                    <h5 class="small"><b>Producida:${productora}</b></h5>
                    <h5 class="small "><b>Fecha de Lanzamiento:${date}</b></h5>
                    <h5 class="small text-warning "><b>Popularidad: <span class= "badge rounded-pill p-1 ${(0, _getColorsJs.getColor)(datos.vote_average)}"> ${datos.vote_average}</span></b></h5>
                    <p class="small"><b>Reseña:${datos.overview}</b></p>
                    <img src="https://image.tmdb.org/t/p/w500${datos.backdrop_path}" alt=""  class="img-fluid rounded-1" width="450px" height="250px">
                  </div>
                </div> `;
...
_c = RenderDetalles;
var _c;
$RefreshReg$(_c, "RenderDetalles");

},{"../../helpers/GetColors.js":"28nM3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fLRTy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "buttonCarrito", ()=>buttonCarrito);
var _verCarritoJs = require("./VerCarrito.js");
const d = document;
function buttonCarrito() {
    const $button = d.createElement("button"), $spam = d.createElement("span"), $header = d.querySelector(".fijo");
    ...
    setTimeout(()=>{
        (0, _verCarritoJs.VerCarrito)();
    }, 100);
}

},{"./VerCarrito.js":"eXnJw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXnJw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "VerCarrito", ()=>VerCarrito);
var _tableJs = require("./Table.js");
const d = document;
function VerCarrito() {
    d.addEventListener("click", (e)=>{
        if (e.target.matches("#mostrarCarrito") || e.target.matches("#mostrarCarrito *")) {
...
_c = VerCarrito;
var _c;
$RefreshReg$(_c, "VerCarrito");

},{"./Table.js":"4cP7F","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4cP7F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function table(pro) {
    setTimeout(()=>{
        ...
        let producto, html = "", precio = 0, titulo = "", total = 0;
        if (pro) producto = pro;
        else producto = (0, _apiPeliJsDefault.default).Carrito;
  ...
  `;
        ...
        (0, _saveJs.Savearray)(jsonArray);
    }, 1900);
}

},{"../../helpers/Api_Peli.js":"j9qG8","./Save.js":"eh73e","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eh73e":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Savearray", ()=>Savearray);
...
_c = Savearray;
var _c;
$RefreshReg$(_c, "Savearray");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h6L38":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sidebar", ()=>sidebar);
var _renderCarritoJs = require("./RenderCarrito.js");
const d = document;
function sidebar() {
    const $aside = d.createElement("aside"), $nav = d.createElement("nav"), $h5 = d.createElement("h5"), $button = d.querySelector("#mostrarCarrito");
    ...
    $nav.appendChild((0, _renderCarritoJs.renderCarrito)());
...
},{"./RenderCarrito.js":"8GSzj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8GSzj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderCarrito", ()=>renderCarrito);
var _botonesJs = require("./Botones.js");
const d = document;
function renderCarrito() {
    const $table = d.createElement("table"), $tHead = d.createElement("thead"), $tbody = d.createElement("tbody"), $tFooter = d.createElement("tfoot"), $div = d.createElement("div");
    ...
    $tFooter.innerHTML = `
          ...
          `;
    let divConten = "";
    divConten = (0, _botonesJs.botones)();
...
},{"./Botones.js":"ajoAL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ajoAL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "botones", ()=>botones);
function botones() {
    return `
    <a href="#" class="btn btn-danger" id="vaciarCarrito">Vaciar Carrito</a>
    <a href="#" class="btn btn-success">Realizar Compra</a>
    `;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bWJYu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Comprar", ()=>Comprar);
var _cargarComprarJs = require("./CargarComprar.js");
const d = document;
function Comprar() {
    d.addEventListener("click", (e)=>{
        if (e.target.name === "comprar") {
            e.preventDefault();
            let id = e.target.id, name = e.target.name, tipo = e.target.dataset.tipo;
            (0, _cargarComprarJs.cargarCompra)(id, name, tipo);
        }
        ...
        if (e.target.matches(".bx-trash")) {
            e.preventDefault();
            let id = e.target.id, name = e.target.dataset.name;
            (0, _cargarComprarJs.eliminarCarrito)(id, name);
        }
    });
}
_c = Comprar;
...
},{"./CargarComprar.js":"3lG5H","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3lG5H":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "cargarCompra", ()=>cargarCompra);
parcelHelpers.export(exports, "eliminarCarrito", ()=>eliminarCarrito);
var _apiPeliJs = require("../../helpers/Api_Peli.js");
var _apiPeliJsDefault = parcelHelpers.interopDefault(_apiPeliJs);
var _agregarAlCarritoJs = require("./AgregarAlCarrito.js");
var _buscarLocalStoreJs = require("./BuscarLocalStore.js");
var _saveJs = require("./Save.js");
var _tableJs = require("./Table.js");
async function cargarCompra(id, name, tipo) {
    let APIDetalle = "";
    if (tipo == "Cine") APIDetalle = `https://api.themoviedb.org/3/movie/${id}?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-ES`;
    else APIDetalle = `https://api.themoviedb.org/3/tv/${id}?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-ES`;
    try {
        ...
        if (resp.status === 200) {
            const datos = await resp.json();
            //  console.log(datos);
            (0, _agregarAlCarritoJs.AgregarAlcarrito)(datos, id, tipo);
            (0, _tableJs.table)();
        } else console.log("error del api");
    } catch (error) {
        console.log(error);
...
function eliminarCarrito(id, name) {
    let resp = confirm("Seguro que desea eliminar esta Pelicula: " + name), carrito = (0, _apiPeliJsDefault.default).Carrito;
    if (resp) {
        let producto;
        producto = carrito.filter((pelicula)=>pelicula.id != parseInt(id));
        console.log(producto);
        (0, _saveJs.Savearray)(producto);
        (0, _tableJs.table)(producto);
        setTimeout(()=>{
            location.reload(true);
        }, 2000);
    }
...
},{"../../helpers/Api_Peli.js":"j9qG8","./AgregarAlCarrito.js":"aHCQ5","./BuscarLocalStore.js":"6cv0j","./Save.js":"eh73e","./Table.js":"4cP7F","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aHCQ5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AgregarAlcarrito", ()=>AgregarAlcarrito);
var _apiPeliJs = require("../../helpers/Api_Peli.js");
var _apiPeliJsDefault = parcelHelpers.interopDefault(_apiPeliJs);
function AgregarAlcarrito(datos, id, tipo) {
    let { title , name  } = datos;
    let carrito = (0, _apiPeliJsDefault.default).Carrito;
    let titulo = title;
    if (titulo === undefined) titulo = name;
    if (carrito.find((el)=>el.id == id)) alert(`El producto ${titulo} ya esta  el carrito`);
    else {
...
_c = AgregarAlcarrito;
var _c;
$RefreshReg$(_c, "AgregarAlcarrito");

},{"../../helpers/Api_Peli.js":"j9qG8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6cv0j":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "buscarLocalStore", ()=>buscarLocalStore);
var _apiPeliJs = require("../../helpers/Api_Peli.js");
var _apiPeliJsDefault = parcelHelpers.interopDefault(_apiPeliJs);
var _tableJs = require("../Carrito/Table.js");
function buscarLocalStore() {
    let local = localStorage.getItem("products");
    let array = local;
    if (array) {
        (0, _apiPeliJsDefault.default).Carrito = JSON.parse(array);
        setTimeout(()=>{
            (0, _tableJs.table)();
        }, 100);
    }
...
},{"../../helpers/Api_Peli.js":"j9qG8","../Carrito/Table.js":"4cP7F","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1xC6H","6Xfl7","hbtnW"], "hbtnW", "parcelRequire2bee")

//# sourceMappingURL=index.5f1ec19f.js.map
